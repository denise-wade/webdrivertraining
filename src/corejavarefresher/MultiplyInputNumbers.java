...
public class MultiplyInputNumbers {
    ...
    public static void main(String[] args)  {
        ...
        for (int i = 0; i < args.length; i++) {
        	multiplyInputNumbers = multiplyInputNumbers * Integer.parseInt(args[i]);
        }
        System.out.println("The Total after multiplication of all the arguments passed is " + multiplyInputNumbers);
